  ...
  render() {
    ...
    return (
      <div className="loginWrapper">
        <h3 className="loginHeading text-center">Login with your social account and share your books or other education resources to educate others in need</h3>
